...
export const costEstimationService = {
  ...
  getAllApprovalEstimation: (id) => axios.get(`${API_BASE_URL}/approval/${id}`),
  ...
  approveCostEstimation: (id,status) => axios.patch(`${API_BASE_URL}/approval/${id}?estimationStatus=${status}`)
};